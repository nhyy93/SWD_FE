        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Col md={12}>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  as="textarea"
                  rows={3}
                  placeholder="Describe your ride, terrain, pace, and what riders should expect..."
            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p className="text-muted mb-0 mt-1">Make this ride private and require a password to join</p>
                </div>
                <Form.Check
                  type="switch"
                  id="private-switch"
          ...
          {isPrivate && (
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="password"
                placeholder="Enter a password for your private ride"
                isInvalid={!!errors.password}
                {...register("password")}
              />
              <Form.Text className="text-muted">Share this password with the riders you want to invite</Form.Text>
              {errors.password && (
